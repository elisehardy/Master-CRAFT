...
namespace mastercraft::cube {
    ...
    TreeGenerator::Tree TreeGenerator::jungleTree(glm::vec3 position) {
        ...
        if (trunk == 4) {
            ...
            tree.emplace_back(glm::ivec3(position.x + 2, position.y + 1 + trunk, position.z + 1),
                              CubeType::LEAVES_JUNGLE
            );
            tree.emplace_back(glm::ivec3(position.x + 3, position.y + 1 + trunk, position.z - 1),
                              CubeType::LEAVES_JUNGLE
            ...
            //two floor
            tree.emplace_back(glm::ivec3(position.x + 2, position.y + 1 + trunk + 1, position.z),
                              CubeType::LEAVES_JUNGLE
            );
            tree.emplace_back(glm::ivec3(position.x + 1, position.y + 1 + trunk + 1, position.z),
                              CubeType::LEAVES_JUNGLE
            );
            ...
            tree.emplace_back(glm::ivec3(position.x, position.y + 1 + trunk + 1, position.z + 1),
                              CubeType::LEAVES_JUNGLE
            );
            tree.emplace_back(glm::ivec3(position.x - 1, position.y + 1 + trunk + 1, position.z + 1),
                              CubeType::LEAVES_JUNGLE
